...
/**
 * UUIDs and constant values for working with GATT characteristics and descriptors.
 *
 */
public class BleCharacteristics {
	...
	public static final String FIND_CENTRAL_CONFIG = "1daa5375-02d3-4b47-b6b7-53408ff159e5";
	...
	public static final UUID CHAR_TX_POWER_LEVEL = UUID.fromString("00002a07-0000-1000-8000-00805f9b34fb");
	public static final UUID CHAR_FIND_CENTRAL_CONFIG = UUID.fromString("1daa5375-02d3-4b47-b6b7-53408ff159e5");
  	public static final UUID CHAR_SIMPLE_KEYS_KEYPRESSED_UUID = UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb");
  	public static final UUID CHAR_HEART_RATE_MEASUREMENT = UUID.fromString("00002a37-0000-1000-8000-00805f9b34fb");
  	public static final UUID CHAR_CLIENT_CHARACTERISTIC_CONFIG = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb"); 
